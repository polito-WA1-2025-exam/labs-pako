        ...
        <Card className="h-100">
          <Card.Body>
            ...
            <ListGroup variant="flush" numbered>
              <ListGroup.Item className="border-0">Browse participating establishments</ListGroup.Item>
              <ListGroup.Item className="border-0">Sign up or log in to see available bags</ListGroup.Item>
              <ListGroup.Item className="border-0">Reserve your bags from your favorite places</ListGroup.Item>
              <ListGroup.Item className="border-0">Pick up your food at the designated time</ListGroup.Item>
              <ListGroup.Item className="border-0">Enjoy delicious food at a discount while reducing waste</ListGroup.Item>
            </ListGroup>
          </Card.Body>
        </Card>
      </Col>
